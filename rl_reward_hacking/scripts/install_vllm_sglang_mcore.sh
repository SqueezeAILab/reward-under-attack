...
pip install "transformers[hf_xet]>=4.51.0" accelerate datasets peft==0.17.0 hf-transfer \
    "numpy<2.0.0" "pyarrow>=15.0.0" pandas \
    ray[default]==2.48.0 codetiming hydra-core pylatexenc qwen-vl-utils wandb dill pybind11 liger-kernel mathruler \
